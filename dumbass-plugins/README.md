...
| `retrieval-planner` | onRequest | Picks arms (mem0 / Terrestrial Brain / code-review-graph — any, all, none), queries in parallel, injects under a context-scaled budget |
...
plugins (wrapper expects two arguments, is called with one).
